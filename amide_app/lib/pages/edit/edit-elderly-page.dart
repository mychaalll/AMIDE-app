...
class EditElderly extends StatefulWidget {
  final Elderly currentElderly;
  const EditElderly({super.key, required this.currentElderly});

  @override
  State<EditElderly> createState() => _EditElderlyState();
}

List<String> sexList = <String>['Male', 'Female'];

class _EditElderlyState extends State<EditElderly> {
  late String newName;
  late String newSex;
  late String newAge;
  late bool newActive;
